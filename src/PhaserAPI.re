...
type scaleConfig = {
  [@bs.optional]
  width: int,
  [@bs.as "width"] [@bs.optional]
  widthAsString: string,
  [@bs.optional]
  height: int,
  [@bs.as "height"] [@bs.optional]
...
type arcadeWorldConfig = {
  ...
  debugShowBody: bool,
  [@bs.optional]
  debugShowStaticBody: bool,
  [@bs.optional]
  debugShowVelocity: bool,
  [@bs.optional]
  debugBodyColor: int,
  [@bs.optional]
  debugStaticBodyColor: int,
  [@bs.optional]
  debugVelocityColor: int,
  [@bs.optional]
  maxEntries: int,
  [@bs.optional]
  useTree: bool,
...
type matterWorldConfig = {
  ...
  [@bs.optional]
  enableSleeping: bool,
  [@bs.as "timing.timestamp"] [@bs.optional]
  timingTimeStamp: int,
  [@bs.as "timing.timescale"] [@bs.optional]
  timingTimeScale: int,
  [@bs.optional]
  enabled: bool,
  [@bs.optional]
  ...
  [@bs.optional]
  debugShowInternalEdges: bool,
  [@bs.optional]
  debugShowConvexHulls: bool,
  [@bs.optional]
  debugShowSleeping: bool,
};
...
module Math = {
  module Vector2 = {
    ...
    external make: (int, int) => t = "Vector2";
    [@bs.module "phaser"] [@bs.scope "Math"] [@bs.new]
    external makeF: (float, float) => t = "Vector2";
    [@bs.get] external x: t => int = "x";
    [@bs.get] external y: t => int = "y";
    /** Methods Add */ [@bs.send] external add: (t, t) => t = "add";
...
module Time = {
  ...
  type timerEventConfigT = {
    ...
    callback: unit => unit,
    [@bs.optional]
    callbackScope: Utils.any,
    [@bs.optional]
    args: array(Utils.any),
    [@bs.optional]
    timeScale: int,
    [@bs.as "timeScale"] [@bs.optional]
    timeScaleF: float,
    [@bs.optional]
    startAt: int,
    [@bs.optional]
  ...
  module Clock = {
    type t = clockT;
    [@bs.module "phaser"] [@bs.scope "Time"] [@bs.new]
    external make: sceneT => t = "Clock";
  ...
  module TimerEvent = {
    type t = timerEventT;
    [@bs.module "phaser"] [@bs.scope "Time"] [@bs.new]
    external make: timerEventConfigT => t = "TimerEvent";
    [@bs.get] external paused: t => bool = "paused";
...
module Sound = {
  ...
  [@bs.deriving abstract]
  type audioSpriteSoundT = {spritemap: spriteMapT};
  ...
  module BaseSound = {
    ...
    [@Bs.send]
    external playWithConfig: (t, string, soundConfigT) => bool = "play";
    [@bs.send]
    external removeMarker: (t, string) => Js.Nullable.t(soundMarkerT) =
      "removeMarker";
  ...
  module BaseSoundManager = {
    ...
    [@bs.send]
    external addAudioSprite: (t, string, soundConfigT) => audioSpriteSoundT =
      "addAudioSprite";
...
module Input = {
  ...
  module InputManager = {
    ...
    [@bs.get]
    external keyboard: t => Js.Nullable.t(keyboardManagerT) = "keyboard";
    [@bs.get] external mouse: t => Js.Nullable.t(mouseManagerT) = "mouse";
    [@bs.get] external scaleManager: t => scaleManagerT = "scaleManager";
    [@bs.get]
    external mousePointer: t => Js.Nullable.t(pointerT) = "mousePointer";
    ...
    [@bs.send] external destroy: t => unit = "destroy";
    [@bs.send]
    external addPointer: (t, int) => array(pointerT) = "addPointer";
    [@bs.send] external boot: t => unit = "boot";
    [@bs.send]
    external pointWithinHitArea: (t, gameObjectT, int, int) => bool =
      "pointWithinHitArea";
    [@bs.send]
    external setDefaultCursor: (t, string) => unit = "setDefaultCursor";
    [@bs.send]
    external transformPointer: (t, pointerT, int, int, bool) => unit =
      "transformPointer";
    [@bs.send]
    external updateInputPlugins: (t, int, array(pointerT)) => unit =
      "updateInputPlugins";
  };
  ...
  module Keyboard = {
    ...
    module Key = {
      type keyT;
      type t = keyT;
      [@bs.module "phaser"] [@bs.scope ("Input", "Keyboard")] [@bs.new]
      external make: (keyboardPluginT, int) => t = "Key";
    ...
    module KeyCombo = {
      ...
      [@bs.get] external matched: t => bool = "matched";
      [@bs.get] external maxKeyDelay: t => int = "maxKeyDelay";
      [@bs.get] external resetOnMatch: t => bool = "resetOnMatch";
      [@bs.get] external resetOnWrongKey: t => bool = "resetOnWrongKey";
      [@bs.get] external size: t => int = "size";
      [@bs.get] external sizeF: t => float = "size";
      [@bs.get] external timeLastMatched: t => int = "timeLastMatched";
      [@bs.get] external timeLastMatchedF: t => float = "timeLastMatched";
    ...
    module KeyboardPlugin = {
      ...
      [@bs.get] external scene: t => sceneT = "scene";
      [@bs.get]
      external sceneInputPlugin: t => inputPluginT = "sceneInputPlugin";
      ...
      [@bs.send]
      external addCaptureIntArr: (t, array(int)) => t = "addCapture";
      [@bs.send]
      external checkDownKey: (t, Key.t, int) => bool = "checkDownKey";
      [@bs.send]
      external createCursorKeys: t => cursorKeysT = "createCursorKeys";
      ...
      [@bs.send]
      external disableGlobalCapture: t => t = "disableGlobalCapture";
      ...
      [@bs.send]
      external removeCaptureIntArr: (t, array(int)) => t = "removeCapture";
      [@bs.send]
      external removeKey: (t, Key.t, ~destroy: bool=?, unit) => t =
        "removeKey";
      [@bs.send]
      external removeKeyStr: (t, string, ~destroy: bool=?, unit) => t =
        "removeKey";
      [@bs.send]
      external removeKeyInt: (t, int, ~destroy: bool=?, unit) => t =
        "removeKey";
      [@bs.send] external getCaptures: t => array(int) = "getCaptures";
      [@bs.send]
      external addKey:
        (t, Key.t, ~enableCapture: bool=?, ~emitOnRepeat: bool=?, unit) =>
        Key.t =
        "addKey";
      [@bs.send]
      external addKeysStr:
        (t, string, ~enableCapture: bool=?, ~emitOnRepeat: bool=?, unit) => 'a =
        "addKeys";
      [@bs.send]
      external createCombo:
        (t, string, ~config: keyComboConfigT=?, unit) => KeyCombo.t =
        "createCombo";
      include Events.EventEmitter({
        type nonrec t = t;
      });
  ...
  module Pointer = {
    ...
    [@bs.send]
    external forwardButtonReleased: t => bool = "forwardButtonReleased";
    [@bs.send] external destroy: t => unit = "destroy";
    [@bs.send] external middleButtonDown: t => bool = "middleButtonDown";
    [@bs.send]
    external middleButtonReleased: t => bool = "middleButtonReleased";
    ...
    [@bs.send]
    external updateWorldPoint: (t, camera2DT) => t = "updateWorldPoint";
  };
...
module Display = {
  module Masks = {
    ...
    module GeometryMask = {
      ...
      [@bs.send] external destroy: t => unit = "destroy";
      [@bs.send]
      external setInvertAlpha: (t, ~value: bool) => t = "setInvertAlpha";
...
module Textures = {
  ...
  module Frame = {
    ...
    [@bs.send]
    external setSize:
      (t, ~width: int, ~height: int, ~x: int=?, ~y: int=?, unit) => t =
      "setSize";
    [@bs.send] external destroy: t => unit = "destroy";
...
module GameObjects = {
  ...
  type textWordWrapT = {
    ...
    width: int,
    [@bs.optional]
    callback: (string, textT) => string,
    [@bs.optional]
    any: Utils.any,
    [@bs.optional]
    useAdvancedWrap: bool,
  };
  [@bs.deriving abstract]
  type textMetricsT = {
    [@bs.optional]
  ...
  type textStyleT = {
    ...
    baseLineY: float,
    [@bs.optional]
    wordWrap: textWordWrapT,
    [@bs.optional]
    metrics: textMetricsT,
  };
  [@bs.deriving abstract]
  type fillStyle = {
    [@bs.optional]
    ...
    [@bs.optional]
    alpha: int,
    [@bs.as "color"] [@bs.optional]
    colorF: float,
    [@bs.as "alpha"] [@bs.optional]
    alphaF: float,
  };
  [@bs.deriving abstract]
  type lineStyle = {
  ...
  module BaseGameObject = (G: {type t;}) => {
    [@bs.module "phaser"] [@bs.scope "GameObjects"] [@bs.new]
    external makeBase: (sceneT, string) => gameObjectT = "GameObject";
    ...
    [@bs.get]
    external input: G.t => Js.Nullable.t(Input.interactiveObjectT) = "input";
  ...
  module Components = {
    module Alpha = (A: {type t;}) => {
      ...
      [@bs.set]
      external setAlphaBottomleft: (A.t, int) => unit = "alphaBottomLeft";
      [@bs.set]
      external setAlphaBottomLeftf: (A.t, float) => unit = "alphaBottomRight";
      [@bs.set]
      external setAlphaBottomRight: (A.t, int) => unit = "alphaBottomRight";
      ...
      [@bs.set]
      external setAlphaTopLeftF: (A.t, float) => unit = "alphaTopLeft";
      [@bs.get] external alphaTopRight: A.t => int = "alphaTopRight";
      [@bs.get] external alphaTopRightF: A.t => float = "alphaTopRight";
      [@bs.set]
      external setAlphaTopRight: (A.t, int) => unit = "alphaTopRight";
      [@bs.set]
      external setAlphaTopRightF: (A.t, float) => unit = "alphaTopRight";
    ...
    module BlendMode = (B: {type t;}) => {
      ...
      [@bs.send]
      external setBlendModeStr: (B.t, string) => B.t = "setBlendMode";
      [@bs.send]
      external setBlendMode: (B.t, blendModesT) => B.t = "setBlendMode";
    };
    ...
    module Transform = (T: {type t;}) => {
      ...
      [@bs.send]
      external setScale: (T.t, ~x: int, ~y: int=?, unit) => T.t = "setScale";
      [@bs.send]
      external setPosition:
        (T.t, ~x: int=?, ~y: int=?, ~z: int=?, ~w: int=?, unit) => T.t =
        "setPosition";
      [@bs.send]
      external setPositionF:
        (T.t, ~x: float, ~y: float, ~z: float, ~w: float) => T.t =
        "setPosition";
      [@bs.send] external getParentRotation: T.t => int = "getParentRotation";
      [@bs.send]
      external getParentRotationF: T.t => float = "getParentRotation";
    ...
    module Pipeline = (P: {type t;}) => {
      [@bs.get]
      external defaultPipeline: P.t => webGLPipelineT = "defaultPipeline";
      [@bs.get] external pipeline: P.t => webGLPipelineT = "pipeline";

      [@bs.send] external getPipelineName: P.t => string = "getPipelineName";
      [@bs.send]
      external initPipeline: (P.t, ~pipelineName: string=?, unit) => bool =
        "initPipeline";
      [@bs.send] external resetPipeline: P.t => bool = "resetPipeline";
      [@bs.send]
      external setPipeline: (P.t, ~pipelineName: string=?, unit) => P.t =
        "setPipeline";
    };
    ...
    module Origin = (O: {type t;}) => {
      ...
      [@bs.send]
      external setDisplayOrigin: (O.t, ~x: float, ~y: float=?, unit) => O.t =
        "setDisplayOrigin";
      [@bs.send]
      external setOrigin: (O.t, ~x: float, ~y: float=?, unit) => O.t =
        "setOrigin";
      [@bs.send]
      external setOriginFromFrame: O.t => O.t = "setOriginFromFrame";
      [@bs.send]
      external updateDisplayOrigin: O.t => O.t = "updateDisplayOrigin";
    };
    ...
    module Size = (S: {type t;}) => {
      ...
      [@bs.send]
      external setSize: (S.t, ~width: int, ~height: int) => S.t = "setSize";
      [@bs.send]
      external setSizeF: (S.t, ~width: float, ~height: float) => S.t =
        "setSize";
      [@bs.send]
      external setDisplaySize: (S.t, ~width: int, ~height: int) => S.t =
        "setDisplaySize";
      [@bs.send]
      external setDisplaySizeF: (S.t, ~width: float, ~height: float) => S.t =
        "setDisplaySize";
      [@bs.send]
      external setSizeToFrame: (S.t, ~frame: Textures.frameT) => S.t =
        "setSizeToFrame";
    };
    ...
    module ComputedSize = (CS: {type t;}) => {
      ...
      [@bs.send]
      external setSize: (CS.t, ~width: int, ~height: int) => CS.t = "setSize";
      [@bs.send]
      external setSizeF: (CS.t, ~width: float, ~height: float) => CS.t =
        "setSize";
      [@bs.send]
      external setDisplaySize: (CS.t, ~width: int, ~height: int) => CS.t =
        "setDisplaySize";
      [@bs.send]
      external setDisplaySizeF: (CS.t, ~width: float, ~height: float) => CS.t =
        "setDisplaySize";
    };
    ...
    module Crop = (C: {type t;}) => {
      ...
      [@bs.send]
      external setCrop:
        (C.t, ~x: int=?, ~y: int=?, ~width: int=?, ~height: int=?, unit) => C.t =
        "setCrop";
    };
    ...
    module TextureCrop = (TC: {type t;}) => {
      ...
      [@bs.send]
      external setCrop:
        (TC.t, ~x: int=?, ~y: int=?, ~width: int=?, ~height: int=?, unit) =>
        TC.t =
        "setCrop";
      [@bs.send]
      external setTexture: (TC.t, ~key: string, ~frame: string=?, unit) => TC.t =
        "setTexture";
      [@bs.send]
      external setFrame:
        (
    ...
    module ScrollFactor = (SF: {type t;}) => {
      ...
      [@bs.set]
      external setScrollFactorXF: (SF.t, float) => unit = "scrollFactorX";
      [@bs.get] external scrollFactorY: SF.t => int = "scrollFactorY";
      [@bs.get] external scrollFactorYF: SF.t => float = "scrollFactorY";
      [@bs.set]
      external setScrollFactorYF: (SF.t, float) => unit = "scrollFactorY";
      [@bs.send]
      external setScrollFactor: (SF.t, ~x: int, ~y: int=?, unit) => SF.t =
        "setScrollFactor";
      [@bs.send]
      external setScrollFactorF: (SF.t, ~x: float, ~y: float=?, unit) => SF.t =
        "setScrollFactor";
    };
    ...
    module Texture = (T: {type t;}) => {
      ...
      [@bs.send]
      external setFrame:
        (T.t, string, ~updateSize: bool=?, ~updateOrigin: bool=?) => T.t =
        "setFrame";
      [@bs.send]
      external setTexture: (T.t, string, ~frame: string=?, unit) => T.t =
        "setTexture";
      [@bs.send]
      external setTextureIndex: (T.t, string, ~frame: int=?, unit) => T.t =
        "setTexture";
    };
  };
  ...
  module Text = {
    ...
    [@bs.module "phaser"] [@bs.scope "GameObjects"] [@bs.new]
    external make:
      (sceneT, ~x: int, ~y: int, ~text: string, ~style: textStyleT) => t =
      "Text";
    ...
    [@bs.send]
    external setBackgroundColor: (t, string) => t = "setBackgroundColor";
    ...
    [@bs.send]
    external setMaxLines: (t, ~max: int=?, unit) => t = "setMaxLines";
    ...
    [@bs.send]
    external setShadowOffset: (t, int, int) => t = "setShadowOffset";
  ...
  module Image = {
    ...
    [@bs.module "phaser"] [@bs.scope "GameObjects"] [@bs.new]
    external make:
      (sceneT, ~x: int, ~y: int, ~texture: string, ~frame: string=?, unit) => t =
      "Image";
    include BaseGameObject({
      type nonrec t = t;
    });
  ...
  module Graphics = {
    ...
    [@bs.send]
    external createBitmapMask: (t, gameObjectT) => bitmapMask =
      "createBitmapMask";
    [@bs.send]
    external createGeometryMask: (t, t) => geometryMask = "createGeometryMask";
    ...
    [@bs.send]
    external fillCircleF: (t, float, float, float) => t = "fillCircle";
    [@bs.send]
    external fillEllipse: (t, int, int, int, int, int) => t = "fillEllipse";
    [@bs.send]
    external fillEllipseF: (t, float, float, float, float, int) => t =
      "fillElipse";
    [@bs.send]
    external fillGradientStyle: (t, int, int, int, int, int) => t =
      "fillGradientStyle";
    [@bs.send]
    external fillGradientStyleF: (t, int, int, int, int, float) => t =
      "fillGradientStyleF";
    [@bs.send] external fillPath: t => t = "fillPath";
    [@bs.send] external fillPoint: (t, int, int, int) => t = "fillPoint";
    [@bs.send]
    external fillPointF: (t, float, float, float) => t = "fillPoint";
  ...
  module Sprite = {
    ...
    [@bs.module "phaser"] [@bs.scope "GameObjects"] [@bs.new]
    external make:
      (t, sceneT, ~x: int, ~y: int, ~texture: string, ~frame: string=?) => t =
      "Sprite";
    include BaseGameObject({
      type nonrec t = t;
    });
  ...
  module Shader = {
    ...
    [@bs.send] external toJSON: t => jsonGameObjectT = "toJSON";
    [@bs.send]
    external setShaderKey: (t, string, ~textures: array(string)=?, unit) => t =
      "setShaderKey";
    [@bs.send] external setUniform: (t, string, Utils.any) => t = "setUniform";
    [@bs.send]
    external setChannel0: (t, string, ~textureData: Utils.any=?, unit) => t =
      "setChannel0";
    [@bs.send]
    external setChannel1: (t, string, ~textureData: Utils.any=?, unit) => t =
      "setChannel1";
    [@bs.send]
    external setChannel2: (t, string, ~textureData: Utils.any=?, unit) => t =
      "setChannel2";
    [@bs.send]
    external setChannel3: (t, string, ~textureData: Utils.any=?, unit) => t =
      "setChannel3";
    include BaseGameObject({
      type nonrec t = t;
    });
    include Components.ComputedSize({
      type nonrec t = t;
    });
    include Components.Depth({
      type nonrec t = t;
  ...
  module Bob = {
    type t = bobT;
    [@bs.get] external alpha: t => float = "alpha";
    [@bs.get] external flipX: t => bool = "flipX";
    [@bs.get] external flipY: t => bool = "flipY";
    [@bs.get] external frame: t => Textures.Frame.t = "frame";
    [@bs.get] external parent: t => blitterT = "blitter";
    ...
    [@bs.send] external destroy: t => unit = "destroy";
    [@bs.send]
    external reset: (t, ~x: int, ~y: int, ~frame: string=?, unit) => t =
      "reset";
    [@bs.send]
    external resetF: (t, ~x: float, ~y: float, ~frame: string=?, unit) => t =
      "reset";
    [@bs.send] external resetFlip: t => t = "resetFlip";
    [@bs.send] external setAlpha: (t, ~alpha: float) => t = "setAlpha";
    [@bs.send] external setFlip: (t, ~x: int, ~y: int) => t = "setFlip";
    [@bs.send] external setFlipF: (t, ~x: float, ~y: float) => t = "setFlip";
    [@bs.send] external setFlipX: (t, ~x: int) => t = "setFlipX";
    [@bs.send] external setFlipXF: (t, ~x: float) => t = "setFlipx";
    [@bs.send] external setFlipY: (t, ~y: int) => t = "setFlipY";
    [@bs.send] external setFlipYF: (t, ~y: float) => t = "setFlipY";
    [@bs.send]
    external setFrame: (t, ~frame: string=?, unit) => t = "setFrame";
    [@bs.send] external setVisible: (t, ~value: bool) => t = "setVisible";
  };
};
...
module Physics = {
  ...
  module Arcade = {
    ...
    module Body = {
      type t = arcadeBodyT;
      /** Members */ [@bs.get] external allowDrag: t => bool = "allowDrag";
      ...
      [@bs.get]
      external angularAccelerationF: t => float = "angularAcceleration";
      ...
      /** Methods */
      [@bs.send]
      external checkWorldBounds: t => bool = "checkWorldBounds";
      ...
      [@bs.send] external destroy: t => unit = "destroy";
      [@bs.send]
      external drawDebug: (t, GameObjects.graphics) => unit = "drawDebug";
      [@bs.send]
      external getBounds: (t, arcadeBodyBoundsT) => arcadeBodyBoundsT =
        "getBounds";
      ...
      [@bs.send]
      external setAcceleration: (t, int, int) => t = "setAcceleration";
      [@bs.send]
      external setAccelerationF: (t, float, float) => t = "setAcceleration";
      [@bs.send] external setAccelerationX: (t, int) => t = "setAccelerationX";
      [@bs.send]
      external setAccelerationXF: (t, float) => t = "setAccelerationX";
      [@bs.send] external setAccelerationY: (t, int) => t = "setAccelerationY";
      [@bs.send]
      external setAccelerationYF: (t, float) => t = "setAccelerationY";
      [@bs.send] external setAllowDrag: (t, bool) => t = "setAllowDrag";
      [@bs.send] external setAllowGravity: (t, bool) => t = "setAllowGravity";
      [@bs.send]
      external setAllowRotation: (t, bool) => t = "setAllowRotation";
      [@bs.send]
      external setAngularAcceleration: (t, int) => t =
        "setAngularAcceleration";
      [@bs.send]
      external setAngularAccelerationF: (t, float) => t =
        "setAngularAccleration";
      [@bs.send] external setAngularDrag: (t, int) => t = "setAngularDrag";
      [@bs.send] external setAngularDragF: (t, float) => t = "setAngularDrag";
      [@bs.send]
      external setAngularVelocity: (t, int) => t = "setAngularVelocity";
      [@bs.send]
      external setAngularVelcotiyF: (t, float) => t = "setAngularVelocity";
      ...
      [@bs.send]
      external setCircle: (t, int, ~offsetX: int=?, ~offsetY: int=?, unit) => t =
        "setCircle";
      [@bs.send]
      external setCircleF:
        (t, float, ~offsetX: int=?, ~offsetY: int=?, unit) => t =
        "setCircle";
      [@bs.send]
      external setCollideWorldBounds: (t, bool, float, float) => t =
      ...
      [@bs.send]
      external setMaxVelocity: (t, int, int) => t = "setMaxVelocity";
      [@bs.send]
      external setMaxVelocityF: (t, float, float) => t = "setMaxVelocity";
    ...
    module StaticBody = {
      ...
      external setCircleF:
        ...
        "setCircle";
      [@bs.send] external setOffset: (t, int, int) => t = "setOffset";
      /** Fix the Size Parameter, such that it's optional */
      [@bs.send]
      external setOffsetF: (t, float, float) => t = "setOffset";
      [@bs.send] external setSize: (t, int, int, bool) => t = "setSize";
      [@bs.send] external setSizeF: (t, float, float, bool) => t = "setSize";
      [@bs.send] external reset: (t, int, int) => unit = "reset";
      [@bs.send] external resetF: (t, float, float) => unit = "reset";
...
module TweenManager = {
  ...
  let tweenEquationStr = tweenEquation =>
  ...
  type numberTweenBuilderConfig = {
    ...
    [@bs.optional]
    ease: string,
    [@bs.as "ease"] [@bs.optional]
    easeWithFunction: Utils.any => unit,
    [@bs.optional]
    easeParams: array(Utils.any),
    [@bs.optional]
    hold: int,
    [@bs.optional]
    repeat: int,
    ...
    callbackScope: Utils.any,
    [@bs.optional]
    onComplete: (tween, array(Utils.any), Utils.any) => unit,
    [@bs.optional]
    onCompleteParams: array(Utils.any),
    [@bs.optional]
    onCompleteScope: Utils.any,
    [@bs.optional]
    onLoopParams: array(Utils.any),
    [@bs.optional]
    onRepeat: (tween, Utils.any, Utils.any) => unit,
    [@bs.optional]
    onRepeatParams: array(Utils.any),
    [@bs.optional]
    onRepeatScope: Utils.any,
    [@bs.optional]
    onStart: (tween, array(Utils.any), Utils.any) => unit,
    [@bs.optional]
    onStartParams: array(Utils.any),
    [@bs.optional]
    onStartScope: Utils.any,
    [@bs.optional]
    onUpdate: (tween, array(Utils.any), Utils.any) => unit,
    [@bs.optional]
    onUpdateParams: array(Utils.any),
    [@bs.optional]
    onUpdateScope: Utils.any,
    [@bs.optional]
    onYoyo: (tween, array(Utils.any), Utils.any) => unit,
    [@bs.optional]
    onYoyoParams: array(Utils.any),
    [@bs.optional]
    onYoYoScope: Utils.any,
    [@bs.optional]
    onActive: (tween, Utils.any, Utils.any) => unit,
    [@bs.optional]
    onActiveParams: array(Utils.any),
    [@bs.optional]
    onActiveScope: Utils.any,
  };
  ...
  [@bs.send]
  external addCounter: (t, numberTweenBuilderConfig) => tween = "addCounter";
  ...
  [@bs.send]
  external getTweensOf: (t, target) => array(tween) = "getTweensOf";
  ...
  [@bs.send]
  external setGlobalTimeScale: (t, float) => t = "setGlobalTimeScale";
  module Tween = {
    type t = tween;
    include Events.EventEmitter({
      type nonrec t = t;
...
module DOM = {
  type t = phaserDom;
  [@bs.send]
  external addToDom: (t, Dom.htmlElement, string) => Dom.htmlElement =
    "AddToDOM";
  [@bs.send]
  external domContentLoaded: (t, unit => unit) => unit = "DOMContentLoaded";
  [@bs.send] external getInnerHeight: (t, bool) => int = "GetInnerHeight";
  [@bs.send]
  external getScreenOrientation: (t, int, int) => string =
    "GetScreenOrientation";
  [@bs.send]
  external getTarget: (t, Dom.htmlElement) => Dom.htmlElement = "GetTarget";
  [@bs.send] external parseXML: (t, string) => Dom.xmlDocument = "ParseXML";
  [@b.send]
  external removeFromDom: (t, Dom.htmlElement) => Dom.htmlElement =
    "RemoveFromDOM";
};
...
module GameObjectFactory = {
  ...
  [@bs.send]
  external graphics: (t, GameObjects.graphicsOptions) => GameObjects.graphics =
    "graphics";
  [@bs.send]
  external bitmapText:
    (
    ...
    GameObjects.bitmapTextT =
    "bitmapText";
  [@bs.send] external text: (t, int, int, text) => GameObjects.textT = "text";
  [@bs.send]
  external blitter:
    (t, int, int, string, ~frame: string=?, unit) => GameObjects.blitterT =
    "blitter";
  [@bs.send]
  external blitterWithStrFrames:
    (t, int, int, string, string) => GameObjects.blitterT =
    "blitter";
  [@bs.send]
  external blitterWithIntFrames:
    (t, int, int, string, int) => GameObjects.blitterT =
    "blitter";
  [@bs.send]
  external circle: (t, int, int, int, int, int) => GameObjects.arc = "circle";
  [@bs.send]
  external container: (t, int, int, gameObjectT) => GameObjects.containerT =
    "container";
  [@bs.send]
  external containerWithArr:
    (t, int, int, array(gameObjectT)) => GameObjects.containerT =
    "container";
  [@bs.send]
  external polygonInt:
    (t, int, int, array(point), int, int) => GameObjects.polygon =
    "polygon";
  [@bs.send]
  external polygonFloat:
    (t, float, float, array(point), int, int) => GameObjects.polygon =
    "polygon";
  [@bs.send] external extern: t => GameObjects.extern = "extern";
  [@bs.send]
  external sprite:
    (t, int, int, string, ~frame: string=?, unit) => GameObjects.Sprite.t =
    "sprite";
  [@bs.send]
  external imageIntStr:
    (t, int, int, string, ~frame: string=?, unit) => GameObjects.imageT =
    "image";
  [@bs.send]
  external imageIntInt: (t, int, int, string, int) => GameObjects.imageT =
    "image";
  [@bs.send]
  external imageFloatStr:
    (t, float, float, string, string) => GameObjects.imageT =
    "image";
  [@bs.send]
  external imageFloatInt: (t, float, float, string, int) => GameObjects.imageT =
    "image";
  [@bs.send] external existing: (t, gameObjectT) => gameObjectT = "existing";
  [@bs.send]
  external quadStr: (t, int, int, string, string) => GameObjects.quad = "quad";
  [@bs.send]
  external quadInt: (t, int, int, string, int) => GameObjects.quad = "quad";
  [@bs.send] external pathInt: (t, int, int) => GameObjects.path = "path";
  [@bs.send]
  external pathFloat: (t, float, float) => GameObjects.path = "path";
  [@bs.send]
  external tween: (t, tweenBuilderConfig) => TweenManager.tween = "tween";
  [@bs.send]
